...
#SBATCH -p high
#SBATCH -D /group/weimergrp/smh/MARS/analysis
...
DIR=kraken_human_reads

echo -e "Sample\tReadcount" > ${DIR}/MARS_human_readcount.tsv
...
do
    ...
    echo -e "${bname}\t${count}" >> ${DIR}/MARS_human_readcount.tsv
done
